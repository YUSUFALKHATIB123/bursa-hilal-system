        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <AnimatePresence>
              {notificationsOpen && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-72 sm:w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-40"
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 hidden sm:inline max-w-20 truncate">
                {user?.name}
              </span>

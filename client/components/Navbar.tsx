  ...
  const getRoleLabel = (role: string, language: string) => {
    if (language === "ar") {
      switch (role) {
        ...
        case "production": return "مدير الإنتاج";
      ...
      switch (role) {
        ...
        case "production": return "Production Manager";
        default: return "User";
      }
    }
  };
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-14 sm:h-16 px-3 sm:px-6">
        {/* Actions: ترتيب خاص بالعربية */}
        {language === "ar" ? (
          <div className="flex items-center space-x-2 sm:space-x-3 justify-start order-1">
            {/* User menu */}
          ...
          >
                ...
                <div className="min-w-0 max-w-48">
                  <span className="text-sm font-medium text-gray-700 w-full truncate" style={{direction: 'ltr'}}>
                    {user?.name}
                  </span>
            ...
            >
                    <div className="px-4 py-3 border-b border-gray-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-gray-900 w-full truncate" style={{direction: 'ltr'}}>
                            {user?.name}
                          </p>
                    ...
                    >
                      ...
                      <span>{language === "ar" ? "الإعدادات" : t("settings")}</span>
                    </button>
                    <button
                      onClick={() => {
                        setUserMenuOpen(false);
                    ...
                    >
                      ...
                      <span>{language === "ar" ? "تسجيل الخروج" : t("logout")}</span>
                    </button>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 justify-end order-2">
          {/* Language toggle */}
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
        ...
        {/* Search always left in RTL, right in LTR */}
        <div className={`flex items-center flex-1 ${language === "ar" ? "justify-end order-2" : "justify-start order-1"}`}>
          {/* Mobile menu button */}
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
